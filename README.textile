...
<h2>Version 0.8.5.9.1 Change Log</h2>
<ul>
	<li>Exposed onError function</li>
    <li>Fixes for repeat mode</li>
    <li>Fixed end of playlist bug</li>
    <li>Added morhpArt option</li>
    <li>Playlist does not repeat</li>
    <li>Using CSS classes as opposed to div id's</li>
    <li>Added the ability to play a specific song via the API</li>
</ul>
