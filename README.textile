<h1>Swagg Player</h1>
<h2>Cross browser javascript music player for the web! Works in IE 7,8,9, FF 3.5+ (including FF4 RC), Chrome & Safari</h2>
...
<h2>Version 0.8.5.8 Change Log</h2>
<ul>
	<li>Added buttonHover option</li>
    <li>Added defaultAlbumArtHeight option</li>
    <li>Added defaultAlbumArtWidth</li>
    <li>Added the spriteImg configuration</li>
    <li>Swagg Loader is redesigned</li>
    <li>Removed the useArt option</li>
    <li>Removed the playList option</li>
</ul>

<p>A more in depth explaination can be found at http://johnny-ray.com/swaggplayer</p>
